...
# Make sure all the necessary folders exist -----------------------------
  ...
  necessary_folders = c("data", "output/data", "output/plots", "output/reliability", "output/reports", "output/tables", "output/tests_outputs", ".vault", ".vault/output/data", ".vault/data_vault_5", ".vault/data_vault_6")
