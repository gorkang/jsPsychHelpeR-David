...
df_FORM_RAW = read_rds(here::here(".vault/data/df_FORM5.rds"))
df_Status_RAW = read_rds(here::here(".vault/data/df_FORM6.rds"))
...
# df_FORM_RAW contains everyone that filled the form. In run_sensitive_data is joined by SDG (id/RUT). Only the ones that completed the experiment have id.
